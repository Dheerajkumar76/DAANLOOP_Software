...
def home():
    ...
    return render_template('sprint1/home.html', listings=listings, categories=CATEGORIES)
...
def dashboard():
    ...
    return render_template('sprint1/dashboard.html', listings=my_listings, total=total)
